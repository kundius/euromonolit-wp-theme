          ...
          <div class="contacts-layout">
            ...
            <div class="contacts-body__maps">
              <div class="contacts-map">
                <input class="contacts-map__radio" id="one" name="group" type="radio" checked>
                <input class="contacts-map__radio" id="two" name="group" type="radio">
                <div class="contacts-map__tabs">
                  <label class="contacts-map__tab" id="one-tab" for="one">Офис на карте</label>
                  <label class="contacts-map__tab" id="two-tab" for="two">Склад на карте</label>
                </div>
                <div class="contacts-map__panels">
                  <div class="contacts-map__panel" id="one-panel">
                  ...
                  <div class="contacts-map__panel" id="two-panel">
